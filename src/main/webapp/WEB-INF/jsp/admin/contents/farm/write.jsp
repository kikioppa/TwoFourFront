...
<body>
	...
	<div class="contWarp">
		...
		<div class="contents">
			...
			<input type="hidden" name="contents_gubun" id="contents_gubun" value="C3"/>
			<input type="hidden" name="category1" id="category1" value="A"/>
			...
			<input type="hidden" name="returnUrl" id="returnUrl" value="<c:url value='${adminUri}contents/total/write.do'/>"/>
						...
						<tr>
							...
							<td>
								...
								<select id="category2" name="category2" >
									...
									<c:forEach var="list" items="${category2List}" varStatus="status">
										<option value="${list.code_id }"   ${ detail.category2 == list.code_id ? "selected" : ""  }  >${list.code_name }</option>
									</c:forEach>
...
<!-- 							</td> -->
						...
						<tr>
							<th>체험 프로그램 img</th>
							<td colspan="3"  class="attachFile" id="file_4">
								
								<p><input  name="file_4" id="comFileUploader4" type="file" title="썸네일파일입력"/><span> 파일용량 10MB이하</span></p>
								<p id="comFileList3">
