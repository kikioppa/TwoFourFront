...
<head>
  ...
  <title>문화 1번가 - 매입신청 STEP01</title>
  <script>
    function check(e) {
    ...
    <div class="section-main apply01">
      ...
      <table id="row_add" class="pin-table radio1">
        <tr>
          <td>1</td>
          <td>
            <input type="text" onkeypress="nolang()" maxlength="4">-<input type="text " maxlength="4" onkeypress="nolang(); ">-<input type="text " maxlength="4" onkeypress="nolang(); ">-<input type="text " maxlength="6" onkeypress="nolang(); ">
          </td>
        </tr>
        <tr>
          <td>2</td>
      ...
      <table id="row_add2" class="pin-table radio2">
        <tr>
          <td>1</td>
          <td>
            <input type="text" onkeypress="nolang()" maxlength="4">-<input type="text " maxlength="4" onkeypress="nolang(); ">-<input type="text " maxlength="4" onkeypress="nolang(); ">-<input type="text " maxlength="4" onkeypress="nolang(); ">
          </td>
        </tr>
        <tr>
          <td>2</td>
      ...
      <div class="table-add">
        <button onClick="addrow()">+ 추가하기(10개씩/최대50개까지)</button>
      </div>
      <div class="table-add2">
        <button onClick="addrow2()">+ 추가하기(10개씩/최대50개까지)</button>
      </div>
      <div class="request">
        <div>
          <a href="/"><button class="reset" type="reset">취소</button></a>
          <a href="/purchase/confirm.do"><button class="request" onclick="check2()">매입요청하기</button></a>
        </div>
      </div>
    </div>
  </div>
