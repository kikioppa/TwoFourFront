...
// 			var getId=RegExp(/^[0-9a-zA-Z]([-\.]?[0-9a-zA-Z])*@[0-9a-zA-Z]([-_\.]?[0-9a-zA-Z])*\.[a-zA-Z]{2,3}$/i);
			...
			if($("input:checkbox[id='smsCheckYn']").is(":checked")){
				$("#smsYn").val("Y");
			}else{
				$("#smsYn").val("N");
			}
      ...
      <div class="matters-text">
        ...
        <div>
          ...
          <ol>
            ...
            <li>비밀번호는 영문/숫자/특수문자 2가지 이상조합해서 최소 6자 ~ 12자로 설정해주셔야 합니다.</li>
            <li>휴대폰 인증은 본인명의의 휴대폰으로만 인증가능합니다.(14세 미만 가입불가)</li>
            <li>인증관련 문제시 고객센터 1:1문의 또는 dream@factoress.com 으로 문의해주시기 바랍니다.</li>
          </ol>
        </div>
      </div>
      <div class="join-form">
        <h3>회원정보</h3>
          ...
          <table>
            ...
            <tr>
              <td>휴대폰</td>
              <td>
                <input name="memberPhone" id="memberPhone" type="text"  numberOnly maxlength="14" placeholder="휴대폰번호 “-” 제외 후 입력하세요.">
              </td>
            </tr>
          </table>
      </div>
...
<%--             <label for="checkbox" onclick="check(this)"><img src="${web_server_url}/images/front/ck-icon2.png" alt="빈체크 이미지"></label> 만 14세 이상입니다. --%>
          ...
          <li>
            ...
            <span class="checkbox-label">
              ...
              <div class="popup">
                ...
                <div class="pop_text">
                  제1조(목적)<br> 이 약관은 (주)문상21(이하 "회사"라 함)이 운영하는 인터넷사이트(이하 "사이트"라 함)를 통하여 제공하는 전자상거래 서비스(이하 "서비스"라 함)와 관련하여 "회사"와 "회원"(제2조에 정합니다)의 권리와 의무, 책임사항 및 "회원"의 "서비스" 이용절차에 관한 사항을 규정함을 목적으로 합니다. 이 약관은 PC 통신, 스마트폰(안드로이드폰, 아이폰 등) 앱, 무선 등을 이용하는 전자상거래에
                  대해서도 그 성질에 반하지 않는 한 준용됩니다.<br>
                  <br> 제2조(용어의 정의)<br> ① 이 약관에서 사용하는 용어의 정의는 다음과 같습니다.<br> 1. "회사"가 운영하는 "사이트"(2020. 02. 현재)는 아래와 같습니다.<br> - https://www.ms1st.co.kr/<br> - 추후 "회사"에서 공지하고 제공하는 기타 웹사이트<br> 2. "서비스" : "사이트"에서 "회사"가 지정한 종류의 상품권을 회원으로부터 회사가 매입하고, 매입대금을 지불하는 서비스를
                  말합니다.
                  ...
                  <br> * 부 칙<br> ① 이 약관은 2020년 02월 01일부터 적용됩니다.<br>
                </div>
              </div>
            ...
            <div class="check">            
              ...
              <div class="popup2">
                ...
                <div class="pop_text2">
                  (주)문상21(이하 “회사”)는 고객님의 개인정보를 중요시하며, 안전하게 보호하기 위하여 최선의 노력을 다하고 있습니다. <br> “회사”는 개인정보보호관련 법규 및 정부기관의 가이드 라인을 준수하고 있습니다.<br> 개인정보처리 방침은 관련 법규 또는 보다 나은 서비스의 제공을 위해 변경될 수 있으며, 이 경우 “회사”는 공지사항(또는 개별공지)을 통해 공지하고 있습니다.<br>
                  ...
                  <br> 7. 개인정보 자동수집 장치의 설치, 운영 및 그 거부에 관한 사항<br> 1) “회사”는 더 나은 서비스 제공을 위해 정보를 수시로 저장하고 찾아내는 ‘쿠키(cookie)’를 사용합니다.<br> 2) 쿠키란 문상21 웹사이트를 운영하는데 이용되는 서버가 회원의 컴퓨터로 전송하는 아주 작은 텍스트 파일로서 회원의 컴퓨터 하드디스크에 저장됩니다. 회원은 쿠키 사용여부를 선택할 수 있습니다. 단, 쿠키 사용을
                  거부하였을 경우, 서비스 제공에 어려움이 있을 수 있습니다.<br> 3) 쿠키 설정 거부 방법<br> -사용하는 웹브라우저의 옵션 설정을 통해 모든 쿠키를 허용 또는 쿠키를 저장할 때마다 확인절차를 거치거나, 모든 쿠키의 저장을 거부할 수 있습니다. 단, 쿠키 저장을 거부한 경우, 로그인이 필요한 문상21의 일부 서비스 이용에 어려움이 있을 수 있습니다.<br> 4) 쿠키 사용 허용여부 설정 방법 (Internet
      ...
      <div class="join-sns">
        ...
        <ul>
          ...
          <li>
            <input type="checkbox" name="smsCheckYn" id="smsCheckYn">
            <label for="smsCheckYn" onclick="check(this)"><img src="${web_server_url}/images/front/ck-icon2.png" alt="빈체크 이미지"></label> SMS 마케팅 수신동의</li>
        </ul>
      </div>
      <div class="join-btn">
