...
<head>
	...
	<link rel="Shortcut Icon" href="${mobile_server_url}/images/favicon.ico" />
...
<%-- 	<link rel="stylesheet" type="text/css" href="${mobile_server_url}/css/jquery.bxslider.css" /> --%>
	...
	<script type="text/javascript" src="${mobile_server_url}/js/front/jquery.dotdotdot.min.js"></script>
