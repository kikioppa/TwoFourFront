  ...
  <input type="hidden" id="memberPw" name="memberPw" value="" />
    ...
    <section class="input-form">
      ...
      <div class="input-text-wrap underline-type prefix-icon">
        ...
        <input id="newMemberPw" name="newMemberPw" type ="password" maxlength="15" placeholder="비밀번호를 입력하세요.">
      </div>
      <div class="input-text-wrap underline-type prefix-icon">
		<span class="icon-password-check"></span>
        <input id="newMemberPw2" name="newMemberPw2" type ="password" maxlength="15" placeholder="비밀번호를 입력하세요.">
      </div>
      <div class="input-text-wrap underline-type prefix-icon">
