	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if (totalPage > 0) {
						...
						// 처음으로
						pageBuf.append("<a href='#'  ")				
											.append(" onclick='go_paging(1)'  >")
										.append( "<img src='../../images/sub/btn_page_first.gif' alt='처음 페이지로' /></a>\n");
						...
						if (blockNum > 1) {
							...
							pageBuf.append("<a href='#'  ")				
											...
											.append( "<img src='../../images/sub/btn_page_prev.gif' alt='이전 페이지로' /></a>\n");
				...
				for (int i = ((blockNum - 1) * cntPerblock + 1); i <= (blockNum * cntPerblock); i++) {
					if (i > totalPage) {
						...
						if (i != curPage) {
							...
							pageBuf.append("<a href='#'  class='selected' >").append(i).append("</a>\n");
						}
					}
				}
						...
						if (blockNum != totalBlock) {					
							pageBuf.append("<a href='#'  ")				
											...
											.append("<img src='../../images/sub/btn_page_next.gif' alt='다음 페이지로' /></a>\n");					
						} else {								
							pageBuf.append("<a href='#'  >")
											.append(  "<img src='../../images/sub/btn_page_next.gif' alt='다음 페이지로' /></a>\n");
						}
						...
						pageBuf.append("<a href='#' ")				
										...
										.append( "<img src='../../images/sub/btn_page_last.gif' alt='마지막 페이지로' /></a>\n");
//						
