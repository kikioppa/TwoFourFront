...
import culturelandFront.dao.FileManageDAO;
...
public class FileMngServiceImpl implements FileMngService {
    ...
    public int getNextStringId(Map param) throws Exception{
		return fileMngDAO.getNextStringId(param);
    }
	...
	public int updateThumb(List<FileVO> _result) throws Exception{
		return fileMngDAO.updateThumb(_result);
	}
	
	public int downCountAddCOMTNFILE(FileVO fvot) throws Exception{
		return fileMngDAO.downCountAddCOMTNFILE(fvot);
	}
}
