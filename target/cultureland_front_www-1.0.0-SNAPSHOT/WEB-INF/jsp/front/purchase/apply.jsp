  ...
  $(function() {
    ...
    function nolang() {
      ...
      if (event.keyCode < 48 || event.keyCode > 57) {
    	  console.log('aabb : ' + event.keyCode);
    ...
    function addrow() {
		...
		if(rowCnt >= 50){
			...
			for(var i = 1 + rowCnt; i < rowCnt+11;i++ ){
	    		...
	    		td2.innerHTML =
	    			'<td><input type="text" maxlength="4"  class="inputs">' +
	    			'-' +
	    			'<input type="text" maxlength="4" numberOnly class="inputs">' +
	    			'-' +
	    			'<input type="text" maxlength="4" numberOnly class="inputs">' +
	    			'-' +
	    			'<input type="text" maxlength="6" numberOnly class="inputs"></td>';
	    	}
    ...
    function addrow2() {
		...
		if(rowCnt >= 50){
			...
			for(var i = 1 + rowCnt; i < rowCnt+11;i++ ){
	    		...
	    		td2.innerHTML =
	    			'<td><input type="text" maxlength="4" numberOnly class="inputs">' +
	    			'-' +
	    			'<input type="text" maxlength="4" numberOnly class="inputs">' +
	    			'-' +
	    			'<input type="text" maxlength="4" numberOnly class="inputs">' +
	    			'-' +
	    			'<input type="text" maxlength="4" numberOnly class="inputs"></td>';
	    	}
...
//     						alert('정상처리 되었습니다.');
    ...
    function isValid(){
//     console.log($('input[name="ckbox3"]').is(":checked"))
		var returnStr = true;		
		var fincheck = true;		
		var finCodeArr = '';
...
<body>
  ...
  <div class="section">
    <div class="section-main apply01">
      ...
      <div class="btn-wrap">
        <button type="button" class="btn-black" onclick="go_large();">대용량 매입신청하기 (50개 이상)</button>
      </div>
      ...
      <h3>매입금앱한도 정책</h3>
      <p class="ref"> * 매입금액한도 정책입니다. 필독하시기 바랍니다.</p>
      <table class="info">
        <tr>
          <td>1회 최소/최대금액</td>
          <td>최소 1만원 이상, 최대 500만원 이하</td>
        </tr>
        <tr>
          <td>1개월 누적 매입한도</td>
          <td>최대 20,000,000원</td>
        </tr>
        <tr>
          <td>1일 누적 매입한도</td>
          <td>최대 10,000,000원</td>
        </tr>
        <tr>
          <td>매입 수수료율</td>
      ...
      <div class="choice">
        ...
        <div class="container">
          <div class="radio">
            <input id="radio-1" name="giftWM" type="radio" checked value="W">
            <label for="radio-1" class="radio-label label1">컬처랜드 문화상품권(컬처랜드에서 발행한 문화상품권 / 온라인문화상품권)</label>
          </div>
          <div class="radio">
            <input id="radio-2" name="giftWM" type="radio" value="M">
            <label for="radio-2" class="radio-label label2">컬처랜드 문화상품권 (컬처랜드에서 발행한 모바일 문화상품권)</label>
          </div>
        </div>
      </div>
...
<%--               <input type="checkbox" name="ckbox3" id="checkbox3">
              <label for="checkbox3"><img src="${web_server_url}/images/front/ck-icon2.png" alt="빈체크 이미지"></label> 개인정보처리방침 --%>
...
<%--               <label for="checkbox4" onclick="check(this)"><img src="${web_server_url}/images/front/ck-icon2.png" alt="빈체크 이미지"></label> 매입 서비스 이용조건 및 매입진행 동의 --%>
      ...
      <h3>상품권 핀코드 입력</h3>
      <p class="ref">*모바일 문화상품권의 경우에는 핀번호가 16자리 입력</p>
      <table id="row_add" class="pin-table radio1">
        <tr>
          <td>1</td>
          <td>
            <input type="text"  class="inputs" maxlength="4">-<input type="text" maxlength="4" numberOnly class="inputs">-<input type="text" maxlength="4" numberOnly class="inputs">-<input type="text" maxlength="6" numberOnly class="inputs">
          </td>
        </tr>
        <tr>
          <td>2</td>
        ...
        <tr onMouseOver="row_add.clickedRowIndex=this.rowIndex">
          <td>10</td>
          <td>
            <input type="text"  class="inputs" maxlength="4">-<input type="text" maxlength="4" numberOnly class="inputs">-<input type="text" maxlength="4" numberOnly class="inputs">-<input type="text" maxlength="6" numberOnly class="inputs">
          </td>
      ...
      <table id="row_add2" class="pin-table radio2">
        <tr>
          <td>1</td>
          <td>
            <input type="text" numberOnly class="inputs" maxlength="4">-<input type="text" maxlength="4" numberOnly class="inputs">-<input type="text" maxlength="4" numberOnly class="inputs">-<input type="text" maxlength="4" numberOnly class="inputs">
          </td>
        </tr>
        <tr>
          <td>2</td>
        ...
        <tr onMouseOver="row_add2.clickedRowIndex=this.rowIndex">
          <td>10</td>
          <td>
            <input type="text" numberOnly class="inputs" maxlength="4">-<input type="text" maxlength="4" numberOnly class="inputs">-<input type="text" maxlength="4" numberOnly class="inputs">-<input type="text" maxlength="4" numberOnly class="inputs">
          </td>
      ...
      <div class="table-add">
        <button type="button" onClick="addrow()">+ 추가하기(10개씩/최대50개까지)</button>
      </div>
      <div class="table-add2">
        <button type="button" onClick="addrow2()">+ 추가하기(10개씩/최대50개까지)</button>
      </div>
      <div class="request">
        <div>
          <button type="button" class="reset" onclick="go_main()" >취소</button>
          <button type="button" class="request" onclick="fn_purchase()">매입요청하기</button>
        </div>
      </div>
    </div>
  </div>
